...
class CartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    int total = cart.entries.fold(0, (sum, entry) => sum + (entry.key.price * entry.value).toInt());
      ...
      body: Column(
        children: [
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  title: Text(car.name),
                  subtitle: Text(
                    '\$${car.price} x $quantity = \$${(car.price * quantity).toStringAsFixed(2)}',
                  ),
                  trailing: Row(
          ...
          Padding(
            ...
            child: Text('Общая сумма: \$${total.toStringAsFixed(2)}', style: const TextStyle(fontSize: 20)),
          ),
        ],
      ),
    );
